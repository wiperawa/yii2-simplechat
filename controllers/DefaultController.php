...
class DefaultController extends Controller
{
    ...
    public function actionIndex($contactId = null, $objectId = null)
    {
        $user = $this->user;

        if (isset($objectId) and isset($contactId)) {
            $current = new Conversation(['user_id' => $user->id, 'contact_id' => $contactId, 'object_id' => $objectId]);
        }
